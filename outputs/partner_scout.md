...
*Generated 2026-04-26 from `db/lai.db`. For pharma BD use — identifies available LAI delivery platforms by indication, payload, duration, and encumbrance status.*

## Availability by indication

Each cell shows indication_fit score (1–5) and encumbrance status. `✓` = open for partnering on this indication. `🔒` = encumbered by an exclusive deal (see Encumbrance log below). `—` = no fit score.

| Platform | Posture | psych | addiction | hiv | oncology | endocrine | ophthalmology | pain | metabolic |
|---|---|---|---|---|---|---|---|---|---|
...
| Perseris | unknown | 3 ✓ | — | — | — | — | — | — | — |
| PolyActiva | unknown | — | — | — | — | — | 3 ✓ | — | — |
| Probuphine | unknown | — | 2 ✓ | — | — | — | — | — | — |
...
Active exclusive deals locking up indication scope by platform. BD scouts should treat these scopes as unavailable absent termination.

| Platform | Indication | Locked by | Since | Molecules | Territory |
|---|---|---|---|---|---|
| BEPO | cns_neuro | AbbVie (2024_abbvie_medincell) | 2024-04-16 | undisclosed | worldwide |
| BEPO | oncology | AbbVie (2024_abbvie_medincell) | 2024-04-16 | undisclosed | worldwide |
...
**Posture:** unknown  
**Open indications:** (none)  
**Closed indications:** (none)  

_Partner view not yet populated for this platform._

### BEPO (MedinCell)

**Posture:** selective  
**Open indications:** addiction, hiv, metabolic, pain  
**Closed indications:** psych, oncology, ophthalmology, cns_neuro, other  

BEPO is the second most-validated in-situ depot LAI platform after FluidCrystal. For BD scouts, BEPO is attractive if your molecule is a small molecule needing 1-3 month duration with strong IP runway (2031 core + continuations to 2038+). Important caveat: most TAs are encumbered. Open scope effectively limited to addiction (commercially crowded), HIV, non-incretin metabolic, pain. AbbVie collaboration locks oncology, ophthalmology, CNS-neuro, and "other"; Teva locks psych. New partner inquiries should focus on the unfilled HIV/metabolic/ pain band or wait for AbbVie program drops to free up space.

### Biochronomer (Heron Therapeutics)
...
### Chroniject (Oakwood Laboratories)
...
### Durasert (EyePoint Pharmaceuticals)
...
### FluidCrystal (Camurus)

**Posture:** selective  
**Open indications:** oncology, ophthalmology, cns_neuro, pain  
**Closed indications:** addiction, metabolic  

Most differentiated in-situ depot for peptides and broad duration range (weekly to six-monthly). For BD scouts, FluidCrystal is the platform of choice if your molecule is a peptide, requires cold-chain-free room-temp stability, or needs duration flexibility. Open indications for new partners: oncology, ophthalmology, CNS-neuro, pain. Closed: addiction (Braeburn), metabolic/endocrine incretins (Lilly), rare-endocrine setmelanotide (Rhythm). Two approved products (Buvidal, Brixadi) and Lund-based commercial CMC capacity reduce technical risk for new programs. Mid-teen royalty has been achieved historically (Braeburn 2014); tier-1 deals compress to mid-single-digit (Lilly 2025).

### ISM (Laboratorios Farmaceuticos Rovi)
...
### Lupron Depot (AbbVie / Takeda (originally Takeda))
...
### MariTide platform (Amgen) (Amgen)

**Posture:** —  
**Open indications:** (none)  
**Closed indications:** metabolic, endocrine  

Not available — internal Amgen asset.
...
### Metsera depot platform (Metsera)

**Posture:** —  
**Open indications:** (none)  
**Closed indications:** metabolic, endocrine  

Not available — Pfizer-acquired.

### NanoCrystal (Alkermes (originally Elan))
...
### Oil decanoate (Multiple (generic platform))
...
### Probuphine (Titan Pharmaceuticals (legacy))
...
### SpectruM (Foresee Pharmaceuticals)
