...
*Notes:* Total deal value up to $870M comprising up to $290M in combined upfront, development, and regulatory milestone payments PLUS up to $580M in sales-based milestones. Tiered mid-single-digit royalties on global net product sales (4-7% range inferred from "mid-single digit" disclosure language). The $290M tranche is reported as a combined upfront-plus-milestones figure — Camurus did not separately disclose the upfront component, which is unusual and suggests Lilly secured less front-loaded economics than headline implies.
...
**Type:** licensing | **Status:** terminated | **Exclusivity:** None | **Territory:** United States  
...
**Economics:** Upfront $10M · milestones $207M  
...
**Description:** Recordati acquired worldwide rights to Novartis' Signifor (immediate-release pasireotide) and Signifor LAR (depot pasireotide) plus the late-stage development asset osilodrostat (LCI699, later approved as Isturisa). Strategic divestiture by Novartis as part of CEO Vas Narasimhan's portfolio pruning; rare-disease commercial focus by Recordati. Agreement signed July 12, 2019; closed October 23, 2019.
  
**Type:** m_and_a | **Status:** active | **Exclusivity:** exclusive | **Territory:** Worldwide  
**Economics:** Upfront $390M  
*Notes:* Confirmed terms per Recordati and Novartis press releases: $390M upfront cash consideration (€351M at deal-close FX) paid at closing, funded by existing Recordati liquidity plus new debt facilities. Additional regulatory milestones tied to osilodrostat (Isturisa) approval and market access plus royalties on osilodrostat sales — specific milestone amounts and royalty rates not disclosed. Note: Signifor and Signifor LAR were not subject to additional milestones or royalties — those applied only to the developmental osilodrostat asset within the bundle.

**TactBio view:** Demonstrates that mature LAI franchises retain meaningful M&A value even at or near patent expiry. The $390M figure provides a reference point for valuing mature peptide LAI assets — useful comp for any Sandostatin LAR or Somatuline divestiture scenario. Important caveat: $390M covered three assets (Signifor IR, Signifor LAR, osilodrostat), so Signifor LAR alone is worth meaningfully less than the headline. Implied LAI-only valuation is probably $150-250M range, consistent with mid-tier endocrine LAI economics at LOE.

### Foresee Pharmaceuticals × Accord Healthcare — 2019-02-11

**Description:** Accord Healthcare licensed global commercialization rights to Camcevi (leuprolide mesylate LAI, FP-001) excluding US, mainland China, Japan, Taiwan, Israel, Turkey, and certain Middle East countries (which were previously partnered or retained). Accord covers all commercialization costs in the territory. Camcevi is Foresee's proprietary 6-month and 3-month subcutaneous leuprolide depot for advanced prostate cancer.
  
**Type:** licensing | **Status:** active | **Exclusivity:** exclusive | **Territory:** Global excl. US, mainland China, Japan, Taiwan, Israel, Turkey, certain Middle East  
**Economics:** milestones $86M  
...
**Type:** licensing | **Status:** active | **Exclusivity:** exclusive | **Territory:** Worldwide  
*Notes:* Specific financial terms genuinely not publicly disclosed by either company. Co-development structure means cost-and-revenue sharing rather than royalty stream — typical of major-pharma combination- product partnerships at this scale. No upfront, milestone, or royalty figures appear in any public Janssen or GSK/ViiV filings or press releases reviewed.

**TactBio view:** Reference precedent for major-pharma HIV LAI partnership economics — but limited as a deal comp because the structure is genuinely opaque. Co-development between two tier-1 organizations bypasses the royalty/milestone disclosures typical of asymmetric platform-licensing deals. Strategic context: Cabenuva's commercial scaling reflects shared economics across two strong commercial organizations rather than a royalty compounder thesis. The structure is closer to a JV than a classical license.

### Camurus × Braeburn — 2014-11-20

**Description:** Exclusive license agreement for Camurus' weekly and monthly subcutaneous buprenorphine injection products (CAM2038, later marketed as Brixadi in the US and Buvidal/Sixmo in EU) for opioid use disorder and pain. Braeburn obtained exclusive rights in North America plus options for Japan, Korea, Taiwan, and China; Camurus retained rest of world. Subsequent 2016 amendment expanded to include CAM2058 (buprenorphine combination products for pain and nausea). Brixadi US launched September 2023 after FDA approval in May 2023.
  
**Type:** licensing | **Status:** active | **Exclusivity:** exclusive | **Territory:** North America (with options for Japan, Korea, Taiwan, China)  
**Economics:** Upfront $20M · milestones $131M · royalty 13%–17%  
*Notes:* Fully disclosed at signing per Camurus November 2014 press release: $20M upfront license fee, $35M development milestones for opioid dependence indication, $21M development milestones for pain indication ($56M development total), up to $75M sales-based milestones, and "mid-teen royalties" on Braeburn product sales. Mid-teen royalties interpreted as 13-17% range. The mid-teen royalty rate is notably high for a platform-licensing deal — reflecting strong negotiating position from Camurus given Braeburn's specialty-pharma focus on addiction therapeutics.

**TactBio view:** Among the best-disclosed LAI platform deals on record — useful as a pricing comp. Mid-teen royalty rate (13-17%) is unusually high for platform licensing and well above the mid-single-digit norm seen in the 2025 Lilly-Camurus deal. Two readings: (1) Braeburn was a smaller-tier counterparty so Camurus could extract better economics; (2) Camurus had strong negotiating position because the platform was earlier-stage and CAM2038 was clearly differentiated. Strategic context for benchmarking: tier-1 pharma deals (Lilly) compress royalties; specialty-pharma deals (Braeburn) preserve them. Brixadi US royalty receipts to Camurus reached SEK 212M (~$20M) in FY2024 implying Braeburn US net sales of ~$130-150M at the disclosed royalty range.
...
**Description:** Original November 2013 development and commercialization agreement covering multiple long-acting injectable products using BEPO technology. Lead asset was risperidone LAI (TV-46000, later marketed as UZEDY, approved April 2023). Subsequent expansions: olanzapine LAI (mdc-TJK), with Royalty Pharma acquiring a portion of the future royalty stream from Teva in late 2023. BEPO is licensed to Teva under the trade name SteadyTeq.
...
**Description:** Alimera licensed worldwide rights to develop and commercialize Iluvien (fluocinolone acetonide intravitreal implant) for diabetic macular edema using EyePoint's Durasert technology. Approved in EU 2012 and US 2014. Long-running collaboration with multiple amendments over time.
  
**Type:** licensing | **Status:** active | **Exclusivity:** exclusive | **Territory:** Worldwide  
*Notes:* Long-running partnership with multiple amendments. EyePoint receives royalties on Alimera Iluvien net sales; specific tiers per amendment history. Subsequent amendments added Yutiq EMEA rights for Alimera. Verify current terms against EyePoint 10-K filings.

**TactBio view:** Long-running ophthalmic LAI partnership demonstrating that platform-product collaborations can sustain over 15+ years through amendments and rights expansions. Strategic context for any new ophthalmic LAI licensing — the structure of platform-licensor + commercialization-partner is durable in the ophthalmic specialty space.
